...
namespace rbkApiModules.Workflow
{
    ...
    {
        protected void Configure<TState, TEvent, TTransition, TStateEntity, TStateChangeEvent, TStateGroup, TQueryDefinitionGroup, TQueryDefinition, TQueryDefinitionToState, TQueryDefinitionToGroup>(EntityTypeBuilder<TStateGroup> entity)
