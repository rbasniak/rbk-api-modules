...
{
    public abstract class BaseClaimToQueryDefinitionConfig
    {
        protected void Configure<TState, TEvent, TTransition, TStateEntity, TClaimToEvent, TStateChangeEvent, TStateGroup, TQueryDefinitionGroup, TQueryDefinition, TQueryDefinitionToState, TQueryDefinitionToGroup, TClaimToQueryDefinition>(EntityTypeBuilder<TClaimToQueryDefinition> entity)
        ...
        {
            entity.HasKey(t => new { t.QueryId, t.Claim });
