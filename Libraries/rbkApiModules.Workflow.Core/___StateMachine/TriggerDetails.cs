...
public sealed class TriggerDetails<TState, TTrigger>
{
    ...
    internal TriggerDetails(TTrigger trigger, IDictionary<TTrigger, TriggerWithParameters<TTrigger>> triggerConfiguration)
    {
        Trigger = trigger;
    ...
    /// </summary>
    public TriggerWithParameters<TTrigger> Parameters { get; }
}
