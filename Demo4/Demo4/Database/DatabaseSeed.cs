...
public class DatabaseSeed : DatabaseSeedManager<DatabaseContext>, IDatabaseSeeder
{
    public DatabaseSeed()
    {
        AddSeed("2023-05-04: Users seed", new SeedInfo<DatabaseContext>((context, serviceProvider) => UsersSeed(context, serviceProvider), EnvironmentUsage.Development | EnvironmentUsage.Testing));
    }
