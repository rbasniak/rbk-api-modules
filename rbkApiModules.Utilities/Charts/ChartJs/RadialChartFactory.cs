...
{
    public class RadialChartFactory : BaseChartFactory<RadialChartFactory, RadialChart>
    {
        public RadialChartFactory(RadialChart chart) : base(chart)
        {

        }

        public static RadialChartFactory CreateRadialCategoryChart(List<NeutralCategoryPoint> data, bool appendExtraData)
        {
            return CreateRadialCategoryChart(data, Int32.MaxValue, String.Empty, appendExtraData);
        }

        public static RadialChartFactory CreateRadialCategoryChart(List<NeutralCategoryPoint> data, int maximumSeries, string mergedLabel, bool appendExtraData)
        {
            ...
            return new RadialChartFactory(chart);
        }

        public RadialChartFactory SetValuesRounding(int decimals)
        {
            var dataset = _chart.Data.Datasets.SingleOrDefault();
        ...
        public RadialChartFactory SetColors(params ColorPallete[] palletes)
        {
            return SetColors(ChartCollorSelector.GetColors(palletes), "ff");
        }

        public RadialChartFactory SetColors(string backgroundTransparency, params ColorPallete[] palletes)
        {
            return SetColors(ChartCollorSelector.GetColors(palletes), backgroundTransparency);
        }

        public RadialChartFactory SetColors(string[] colors, string backgroundTransparency = "ff")
        {
