...
- **Stack:** C# / .NET 10 / ASP.NET Core / Entity Framework Core / FluentValidation / NUnit / SQLite (testing) / SQL Server
- **Test projects:** Demo1.Tests, Demo2.Tests, rbkApiModules.Testing.Core.Tests
- **Testing framework:** rbkApiModules.Commons.Testing — RbkTestingServer<TProgram> for integration tests
