...
public class DefaultAvatarStorageService : IAvatarStorage
{
    ...
    public async Task<string> SaveAsync(string base64Data, string path, string filenameWithoutExtension, string extension, CancellationToken cancellationToken)
    {
    ...
    public async Task<string> SaveAsync(string base64Data, string path, string filenameWithoutExtension, CancellationToken cancellationToken)
    {
        ...
        return await SaveAsync(base64Data, path, filenameWithoutExtension, extension, cancellationToken);
    }
}