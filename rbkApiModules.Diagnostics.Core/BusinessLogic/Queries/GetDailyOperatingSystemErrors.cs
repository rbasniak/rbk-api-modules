...
{
    public class GetDailyOperatingSystemErrors
    {
        ...
        public class Handler : BaseQueryHandler<Command>
        {
            ...
            {
                return await ChartUtils.BuildChartData(_context, request.DateFrom, request.DateTo, x => x.ClientOperatingSystem + " " + x.ClientOperatingSystemVersion, entry => entry.ClientOperatingSystem + " " + entry.ClientOperatingSystemVersion);
            }
        }
    }
}
