...
{
    public class GetDailySourceErrors
    {
        ...
        public class Handler : BaseQueryHandler<Command>
        {
            ...
            {
                return await ChartUtils.BuildChartData(_context, request.DateFrom, request.DateTo, x => x.ExceptionSource, entry => entry.ExceptionSource);
            }
        }
    }
}
