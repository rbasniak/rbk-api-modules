...
{
    public class GetDailyBrowserErrors
    {
        ...
        public class Handler : BaseQueryHandler<Command>
        {
            ...
            {
                return await ChartUtils.BuildChartData(_context, request.DateFrom, request.DateTo, x => x.ClientBrowser, entry => entry.ClientBrowser);
            }
        }
    }
}
