...
{
    public class GetDailyDeviceErrors
    {
        ...
        public class Handler : BaseQueryHandler<Command>
        {
            ...
            {
                return await ChartUtils.BuildChartData(_context, request.DateFrom, request.DateTo, x => x.ClientDevice, entry => entry.ClientDevice);
            }
        }
    }
}
